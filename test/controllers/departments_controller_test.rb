...
class DepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create department" do
    assert_difference("Department.count") do
      post departments_url, params: { department: { capacity: @department.capacity, doctor_id: @department.doctor_id, name: @department.name } }
    end
  ...
  test "should update department" do
    patch department_url(@department), params: { department: { capacity: @department.capacity, doctor_id: @department.doctor_id, name: @department.name } }
